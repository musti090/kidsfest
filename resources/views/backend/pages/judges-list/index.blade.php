...
@section('title','Münsiflərin siyahısı')
@section('content')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-4">
                                    <div class="card card-info ">
                                        <div class="bg-info pt-2 pb-2" id="flip3">
                                            <h5 class="text-center">Münsifin ad,soyadı üzrə axtarış</h5>
                                        </div>
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form id="panel3" action="{{ route('backend.judges-list.search') }}"
                                              method="get" class="form-horizontal">
                                            @csrf
                                            <div class="card-body">
                                                <input type="text" name="name" class="form-control" placeholder="Münsifin ad və soyadı">
                                            </div>
                                            <!-- /.card-body -->
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="pwd">Excel fayl:</label>
                                            <input type="file" class="form-control" id="pwd"  name="file">
                                            @error('file')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <button type="submit" class="btn btn-primary">İmport et</button>
                                    </form>
                                    @endrole
                                </div>
                                <div class="col-sm-4 text-right">
                                    <a href="{{ route('backend.judges-list.create') }}">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tr class="table-tr-bg">
                                    ...
                                    <th class="align-middle text-center">Münsifin adı və soyadı</th>
                                ...
                                @foreach($data as $key => $d)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center font-weight-bold">{{ $d->name }}</td>
                                        <td class="align-middle text-center">
                                            <a  class="btn btn-sm btn-warning"
                                               href="{{ route('backend.judges-list.edit',$d->id) }}">
