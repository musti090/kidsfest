...
@section('title','Məntəqələr üzrə münsiflər')
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="card card-info ">
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form id="panel3" action="{{ route('backend.precincts-has-judges.search') }}"
                                ...
                                <div class="col-sm-4 text-right">
                                    <a href="{{ route('backend.precincts-has-judges.create') }}">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tr class="table-tr-bg">
                                    ...
                                    <th class="align-middle text-center">Münsif</th>
                                ...
                                @foreach($data as $key => $d)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center font-weight-bold">
                                            {{ \App\Models\Precinct::where('id',$d->precinct_id)->firstorFail()->place_name }}
                                        </td>
                                        <td class="align-middle text-center font-weight-bold">
                                            {{ \App\Models\Nomination::where('id',$d->nomination_id)->firstorFail()->name }}
                                        </td>
                                        <td class="align-middle text-center font-weight-bold">
                                            {{ \App\Models\JudgesList::where('id',$d->judge_id)->firstorFail()->name }}
                                        </td>
                                        <td class="align-middle text-center">
                                            <a  class="btn btn-sm btn-warning"
                                               href="{{ route('backend.precincts-has-judges.edit',$d->id) }}">
